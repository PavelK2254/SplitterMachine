let MongoClient;_c24‍.x([["init",()=>init],["addNewOrdersToDB",()=>addNewOrdersToDB],["getOrderByBarcode",()=>getOrderByBarcode]]);_c24‍.w("mongodb",[["MongoClient",["MongoClient"],function(v){MongoClient=v}]]);const collectionName = require("./collectionName.json");
...
var dbo;
    ...
    return new Promise(function(resolve, reject) {
        ...
        dbo.collection(currentCollectionName).findOneAndUpdate({ barcodeNum: +barcode, status: 0 }, { $set: { status: 1 } }, options, function(err, result) {
                if (err) {
                    reject(err)
                } else {
