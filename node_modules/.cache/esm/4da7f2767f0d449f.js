let getProductsJSON,OrderModel,init,addNewOrdersToDB,getOrderByBarcode,resolve;_7f0‍.x([["initDB",()=>initDB],["updateDbWithNewOrders",()=>updateDbWithNewOrders],["addTestOrders",()=>addTestOrders],["getSingleOrder",()=>getSingleOrder]]);_7f0‍.w("../Networking/dataRepository",[["getProductsJSON",["getProductsJSON"],function(v){getProductsJSON=v}]]);_7f0‍.w("../Models/orderModel",[["OrderModel",["OrderModel"],function(v){OrderModel=v}]]);_7f0‍.w("../DAO/dbAccessManager",[["init",["init"],function(v){init=v}],["addNewOrdersToDB",["addNewOrdersToDB"],function(v){addNewOrdersToDB=v}],["getOrderByBarcode",["getOrderByBarcode"],function(v){getOrderByBarcode=v}]]);_7f0‍.w("dns",[["resolve",["resolve"],function(v){resolve=v}]]);
    ...
    init().then(function(result) {
        ordersGetter.then(function(result) {
            ...
            addNewOrdersToDB(ordersCollection).then(function(result) {
                ...
                _7f0‍.g.console.log(result);

            }, function(err) {
                _7f0‍.g.console.error(err);
            })
        }, function(err) {
            _7f0‍.g.console.log(err);
