let getProductsJSON,OrderModel,exampleOrderNums,init,addNewOrdersToDB,getOrderByBarcode,resolve;_afd‍.x([["updateDbWithNewOrders",()=>updateDbWithNewOrders],["addtestOrders",()=>addtestOrders],["getSingleOrder",()=>getSingleOrder]]);_afd‍.w("../Networking/dataRepository",[["getProductsJSON",["getProductsJSON"],function(v){getProductsJSON=v}]]);_afd‍.w("../Models/orderModel",[["OrderModel",["OrderModel"],function(v){OrderModel=v}]]);_afd‍.w("../Utils/orderNumbers",[["exampleOrderNums",["exampleOrderNums"],function(v){exampleOrderNums=v}]]);_afd‍.w("../DAO/dbAccessManager",[["init",["init"],function(v){init=v}],["addNewOrdersToDB",["addNewOrdersToDB"],function(v){addNewOrdersToDB=v}],["getOrderByBarcode",["getOrderByBarcode"],function(v){getOrderByBarcode=v}]]);_afd‍.w("dns",[["resolve",["resolve"],function(v){resolve=v}]]);
    ...
    init().then(function(result) {
        ordersGetter.then(function(result) {
            ...
            addNewOrdersToDB(ordersCollection).then(function(result) {
                ...
                _afd‍.g.console.log(result);

            }, function(err) {
                _afd‍.g.console.error(err);
            })
        }, function(err) {
            _afd‍.g.console.log(err);
