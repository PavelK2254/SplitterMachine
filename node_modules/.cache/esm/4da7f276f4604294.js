let getProductsJSON,OrderModel,init,addNewOrdersToDB,getOrderByBarcode,resolve;_f46‍.x([["initDB",()=>initDB],["updateDbWithNewOrders",()=>updateDbWithNewOrders],["addTestOrders",()=>addTestOrders],["getSingleOrder",()=>getSingleOrder]]);_f46‍.w("../Networking/dataRepository",[["getProductsJSON",["getProductsJSON"],function(v){getProductsJSON=v}]]);_f46‍.w("../Models/orderModel",[["OrderModel",["OrderModel"],function(v){OrderModel=v}]]);_f46‍.w("../DAO/dbAccessManager",[["init",["init"],function(v){init=v}],["addNewOrdersToDB",["addNewOrdersToDB"],function(v){addNewOrdersToDB=v}],["getOrderByBarcode",["getOrderByBarcode"],function(v){getOrderByBarcode=v}]]);_f46‍.w("dns",[["resolve",["resolve"],function(v){resolve=v}]]);
    ...
    init().then(function(result) {
        ordersGetter.then(function(result) {
            ...
            addNewOrdersToDB(ordersCollection).then(function(result) {
                ...
                _f46‍.g.console.log(result);

            }, function(err) {
                _f46‍.g.console.error(err);
            })
        }, function(err) {
            _f46‍.g.console.log(err);
