let getProductsJSON,OrderModel,init,addNewOrdersToDB,getOrderByBarcode,resolve;_0ec‍.x([["initDB",()=>initDB],["updateDbWithNewOrders",()=>updateDbWithNewOrders],["addTestOrders",()=>addTestOrders],["getSingleOrder",()=>getSingleOrder]]);_0ec‍.w("../Networking/dataRepository",[["getProductsJSON",["getProductsJSON"],function(v){getProductsJSON=v}]]);_0ec‍.w("../Models/orderModel",[["OrderModel",["OrderModel"],function(v){OrderModel=v}]]);_0ec‍.w("../DAO/dbAccessManager",[["init",["init"],function(v){init=v}],["addNewOrdersToDB",["addNewOrdersToDB"],function(v){addNewOrdersToDB=v}],["getOrderByBarcode",["getOrderByBarcode"],function(v){getOrderByBarcode=v}]]);_0ec‍.w("dns",[["resolve",["resolve"],function(v){resolve=v}]]);
    ...
    init().then(function(result) {
        ordersGetter.then(function(result) {
            ...
            addNewOrdersToDB(ordersCollection).then(function(result) {
                ...
                _0ec‍.g.console.log(result);

            }, function(err) {
                _0ec‍.g.console.error(err);
            })
        }, function(err) {
            _0ec‍.g.console.log(err);
