let MongoClient;_0d0‍.x([["init",()=>init],["addNewOrdersToDB",()=>addNewOrdersToDB],["getOrderByBarcode",()=>getOrderByBarcode],["getCollectionNames",()=>getCollectionNames]]);_0d0‍.w("mongodb",[["MongoClient",["MongoClient"],function(v){MongoClient=v}]]);const currentCollectionName = require("../Utils/config.json").collectionName;
    ...
    return new Promise(function(resolve, reject) {
        MongoClient.connect(url, options, function(err, db) {
            ...
            dbo.listCollections().toArray(function(err, items) {
                ...
                _0d0‍.g.console.log(dbo.getCollectionNames())
            });
        });
    })
}
