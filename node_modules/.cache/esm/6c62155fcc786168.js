let MongoClient;_cc7‍.x([["availableCollections",()=>availableCollections],["init",()=>init],["addNewOrdersToDB",()=>addNewOrdersToDB],["getOrderByBarcode",()=>getOrderByBarcode],["resetAllStatuses",()=>resetAllStatuses]]);_cc7‍.w("mongodb",[["MongoClient",["MongoClient"],function(v){MongoClient=v}]]);const currentCollectionName = require("../Utils/config.json").collectionName;
...
var dbo;
    ...
    return new Promise(function(resolve, reject) {
        MongoClient.connect(url, options, function(err, db) {
            ...
            dbo.listCollections().toArray(function(err, items) {
                ...
                _cc7‍.u(availableCollections = items);
                if (items.length == 0) {
    ...
    return new Promise(function(resolve, reject) {
       ...
       function getOrderByBarcode(barcode,testMode) {
    return new Promise(function(resolve, reject) {
        if(testMode){
