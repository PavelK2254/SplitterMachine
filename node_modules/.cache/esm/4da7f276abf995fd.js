let getProductsJSON,OrderModel,init,addNewOrdersToDB,getOrderByBarcode,resolve;_abf‍.x([["initDB",()=>initDB],["updateDbWithNewOrders",()=>updateDbWithNewOrders],["addTestOrders",()=>addTestOrders],["getSingleOrder",()=>getSingleOrder]]);_abf‍.w("../Networking/dataRepository",[["getProductsJSON",["getProductsJSON"],function(v){getProductsJSON=v}]]);_abf‍.w("../Models/orderModel",[["OrderModel",["OrderModel"],function(v){OrderModel=v}]]);_abf‍.w("../DAO/dbAccessManager",[["init",["init"],function(v){init=v}],["addNewOrdersToDB",["addNewOrdersToDB"],function(v){addNewOrdersToDB=v}],["getOrderByBarcode",["getOrderByBarcode"],function(v){getOrderByBarcode=v}]]);_abf‍.w("dns",[["resolve",["resolve"],function(v){resolve=v}]]);

//import { exampleOrderNums } from '../Utils/orderNumbers';


var exampleOrdersJson = require('../OrderExamples/20200511.json');
var currentPage = '1';
    ...
    init().then(function (result) {
        ordersGetter.then(function (result) {
            ...
            addNewOrdersToDB(ordersCollection).then(function (result) {
                ...
                _abf‍.g.console.log(result);

            }, function (err) {
                _abf‍.g.console.error(err);
            })
        }, function (err) {
            _abf‍.g.console.log(err);
